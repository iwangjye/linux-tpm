...
extern ssize_t tpm_show_timeouts(struct device *,
				 struct device_attribute *attr, char *);
extern ssize_t tpm2_show_ownerauth_c(struct device *, struct device_attribute *attr,
                char *);
extern ssize_t tpm2_show_endorseauth_c(struct device *, struct device_attribute *attr,
                char *);
extern ssize_t tpm2_show_phenable_c(struct device *, struct device_attribute *attr,
                char *);
extern ssize_t tpm2_show_shenable_c(struct device *, struct device_attribute *attr,
                char *);
extern ssize_t tpm2_show_ehenable_c(struct device *, struct device_attribute *attr,
                char *);
extern ssize_t tpm2_show_pcrs_c(struct device *, struct device_attribute *attr,
                char *);
...
ssize_t	tpm_getcap_c(struct device *, __be32, cap_t *, const char *);

extern int tpm_get_timeouts_c(struct tpm_chip *);
extern void tpm_gen_interrupt_c(struct tpm_chip *);
extern int tpm_do_selftest_c(struct tpm_chip *);
extern unsigned long tpm_calc_ordinal_duration_c(struct tpm_chip *, u32);
extern struct tpm_chip* tpm_register_hardware_c(struct device *,
				 const struct tpm_vendor_specific *);
extern int tpm_open_c(struct inode *, struct file *);
extern int tpm_release_c(struct inode *, struct file *);
extern void tpm_dev_vendor_release(struct tpm_chip *);
extern ssize_t tpm_write_c(struct file *, const char __user *, size_t,
			 loff_t *);
extern ssize_t tpm_read_c(struct file *, char __user *, size_t, loff_t *);
extern void tpm_remove_hardware_c(struct device *);
extern int tpm_pm_suspend_c(struct device *);
extern int tpm_pm_resume_c(struct device *);
extern int wait_for_tpm_stat_c(struct tpm_chip *, u8, unsigned long,
			     wait_queue_head_t *, bool);
extern int tpm2_do_selftest_c(struct tpm_chip *);

#ifdef CONFIG_ACPI
extern int tpm_add_ppi_c(struct kobject *);
extern void tpm_remove_ppi_c(struct kobject *);
#else
